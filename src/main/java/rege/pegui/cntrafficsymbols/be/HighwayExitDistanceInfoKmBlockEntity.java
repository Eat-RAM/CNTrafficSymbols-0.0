...
public class HighwayExitDistanceInfoKmBlockEntity extends BlockEntity
implements Nameable {
    private static final float[] ROUNDS = {
        ...
        3f, 3.1f, 3.2f, 3.3f, 3.4f, 3.5f, 3.6f, 3.7f, 3.8f, 3.9f,
        ...
        8f, 8.1f, 8.2f, 8.3f, 8.4f, 8.5f, 8.6f, 8.7f, 8.8f, 8.9f,
        9f, 9.1f, 9.2f, 9.3f, 9.4f, 9.5f, 9.6f, 9.7f, 9.8f, 9.9f, 10f
    };
    public static final BlockEntityType<HighwayExitDistanceInfoKmBlockEntity>
    TYPE = BlockEntityType.Builder.create(
        HighwayExitDistanceInfoKmBlockEntity::new,
    ...
    public HighwayExitDistanceInfoKmBlockEntity(BlockPos p, BlockState st) {
        super(TYPE, p, st);
    }
    ...
    @Override
    public Text getName() {
        return Text.literal(this.getKmStr());
    }
    ...
    public void setKm(float v) {
        ...
        if (Math.abs(v) < 10f) {
            this.km = Math.copySign(ROUNDS[
                Math.round((float)(Math.abs(v) * 10))
            ], v);
            return;
        }
        this.km = Math.round(v);
    }

    @Override
    protected void writeNbt(NbtCompound nbt) {
        super.writeNbt(nbt);
        nbt.putFloat("km", this.km);
    ...
    public void readNbt(NbtCompound nbt) {
        super.readNbt(nbt);
        this.setKm(nbt.contains("km", NbtElement.FLOAT_TYPE) ?
                   nbt.getFloat("km") : 0f);
    }
