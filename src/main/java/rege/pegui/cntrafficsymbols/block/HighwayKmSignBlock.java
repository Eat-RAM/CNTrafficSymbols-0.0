...
public class HighwayKmSignBlock extends Attachment3DoubleFaceFacingBlock
    ...
    TagKey.of(RegistryKeys.ITEM, new Identifier(
        "cntrafficsymbols_0d0", "locks_highway_km_sign"
    ));

    public HighwayKmSignBlock(Settings settings) {
        super(settings);
    }
    ...
    @Override
    public VoxelShape getOutlineShape(BlockState st, BlockView v,
    ...
    public void onPlaced(
        ...
        if (world.isClient) {
            world.getBlockEntity(pos, HighwayKmSignBlockEntity.TYPE).ifPresent(
