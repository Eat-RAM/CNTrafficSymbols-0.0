...
public class SelfWork {
    ...
    static {
        ...
        ITEM_GROUP = FabricItemGroup.builder().icon(() -> new ItemStack(Items.SPEEDLIMIT_HIGH_120)).displayName(Text.translatableWithFallback("itemGroup.cntrafficsymbols_0d0",
