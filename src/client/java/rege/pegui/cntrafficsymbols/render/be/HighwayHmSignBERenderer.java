...
implements BlockEntityRenderer<HighwayHmSignBlockEntity> {
    ...
    @Override
    public void render(
        HighwayHmSignBlockEntity ett, float tickDelta, MatrixStack matrices,
        ...
        this.renderText(ett.getPos(), tx, matrices, vcs, light, 8, 90, true);
        if (!st.get(FACING).isSingle()) {
            this
            .renderText(ett.getPos(), tx, matrices, vcs, light, 8, 90, false);
        }
        matrices.pop();
    }
