...
EX_NORTH=b"""\
{
  ...
  "elements": [
    ...
    },
    {
      ...
      "to": [%d, %d, 8],
      "faces": {
        "south": {"uv": [5, 3, 7, 4], "texture": "#cover"}
      }
    },
    {
      "from": [%d, %d, 0],
      "to": [%d, %d, 8],
      "faces": {
        "south": {"uv": [4, 1, 8, 3], "texture": "#cover"}
      }
    },
    {
      "from": [%d, %d, 0],
      "to": [%d, %d, 8],
      "faces": {
        "south": {"uv": [5, 0, 7, 1], "texture": "#cover"}
      }
    }
  ]
}
...
for k,v in Y_OFFSETS.items():
 with open(f"rod_with_lamp_down_{v}.json","wb")as f:
  f.write(EX_DOWN%(7+k[0],6+k[1],9+k[0],7+k[1],7+k[0],9+k[1],9+k[0],10+k[1],
                   ...
                   7+k[0],6+k[1],9+k[0],7+k[1],6+k[0],7+k[1],10+k[0],9+k[1],
                   7+k[0],9+k[1],9+k[0],10+k[1]))
